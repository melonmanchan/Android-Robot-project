...
public class OtherJoystick extends View {
	...
	public OtherJoystick(Context context) {
		super(context);
		initJoystickView();
	}

	public OtherJoystick(Context context, AttributeSet attrs) {
		super(context, attrs);
		initJoystickView();
	}

	public OtherJoystick(Context context, AttributeSet attrs, int defStyle) {
